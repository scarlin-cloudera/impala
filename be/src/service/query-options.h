...
constexpr unsigned NUM_QUERY_OPTIONS =
    TImpalaQueryOptions::CALCITE_JOIN_TEST_2 + 1;
#define QUERY_OPTS_TABLE                                                                 \
  ...
  QUERY_OPT_FN(calcite_join_test_1, CALCITE_JOIN_TEST_1, TQueryOptionLevel::REGULAR)                 \
  QUERY_OPT_FN(calcite_join_test_2, CALCITE_JOIN_TEST_2, TQueryOptionLevel::REGULAR)                 \
  ;
