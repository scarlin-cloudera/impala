...
DEFINE_string(cte_suggester_class, "org.apache.impala.calcite.cte.IdentitySuggester",
    "The cte.Suggester implementation to use when suggesting common table expression "
    "(CTE) candidates.");
