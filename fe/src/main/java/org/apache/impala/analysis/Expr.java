...
abstract public class Expr extends TreeNode<Expr> implements ParseNode, Cloneable {
   ...
   * expressions. Exprs that have non-child exprs which should be affected by substitutions
   * must override this method and apply the substitution to such exprs as well.
   */
