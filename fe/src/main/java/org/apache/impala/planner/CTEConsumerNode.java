...
public class CTEConsumerNode extends PlanNode {
  ...
  public void init(Analyzer analyzer) throws ImpalaException {
    ...
    // Collect CTE result expressions for ScalarExpr
    resultExprs_ =
        Expr.substituteList(cteExprs_, ctePlan_.getOutputSmap(), analyzer, true);
  }
  ...
  protected void toThrift(TPlanNode msg) {
    ...
    msg.cte_consumer =
        new TCTEConsumer(cteName_, tupleIds, Expr.treesToThrift(resultExprs_));
  }
