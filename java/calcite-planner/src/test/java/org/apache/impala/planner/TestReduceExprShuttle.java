...
public class TestReduceExprShuttle extends PlannerTestBase {
  protected static final Logger LOG = LoggerFactory.getLogger(TestReduceExprShuttle.class.getName());
  ...
  public void testFoldConcatString() {
    try {
      ...
      assertEquals(1, reducedExprs.size(), 1);
      assertEquals("CAST('ab':VARCHAR(2147483647)):VARCHAR(2147483647)",
