 ...
 */
@Value.Enclosing
public class ImpalaFilterProjectTransposeRule extends FilterProjectTransposeRule {

  public ImpalaFilterProjectTransposeRule(FilterProjectTransposeRule.Config config) {
    super(config);
  }
