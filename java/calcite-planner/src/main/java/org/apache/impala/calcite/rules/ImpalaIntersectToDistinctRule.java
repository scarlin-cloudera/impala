...
/**
 * ImpalaIntersectToDistinctRule is the same as Calcite's IntersectToDistinctRule with
 * only some naming changes.
 * The Calcite code was grabbed from here:
 ...
 * The reason for the existence of this file is because the fix for CALCITE-6893 caused
 * an exception to be thrown. IMPALA-14420 has been filed to fix this problem.
 * 
 */
/**
 ...
 */
@Value.Enclosing
public class ImpalaIntersectToDistinctRule
    extends RelRule<ImpalaIntersectToDistinctRule.Config>
    implements TransformationRule {

  /** Creates an ImpalaIntersectToDistinctRule. */
  protected ImpalaIntersectToDistinctRule(Config config) {
    super(config);
  }

  @Deprecated // to be removed before 2.0
  public ImpalaIntersectToDistinctRule(Class<? extends Intersect> intersectClass,
  ...
  public interface Config extends RelRule.Config {
    Config DEFAULT = ImmutableImpalaIntersectToDistinctRule.Config.builder()
        .operandSupplier(b -> b.operand(LogicalIntersect.class).anyInputs()).build();

    @Override default ImpalaIntersectToDistinctRule toRule() {
      return new ImpalaIntersectToDistinctRule(this);
    }
