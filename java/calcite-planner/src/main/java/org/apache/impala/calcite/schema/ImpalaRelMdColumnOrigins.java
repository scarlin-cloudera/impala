 ...
 *
 * IMPALA NOTE: This file was copied from:
 * https://github.com/apache/calcite/blob/calcite-1.41.0/core/src/main/java/org/...
 * ...apache/calcite/rel/metadata/RelMdColumnOrigins.java
 * It is copied (and changed) over here because:
 * a) the default constructor for RelMdColumnOrigins is private and did not allow
 *    extended classes
 * b) The associated table scan is needed for the RelColumnOrigin class, so this
 *    class calls the needed ImpalaRelColumnOrigin extension.
 */
public class ImpalaRelMdColumnOrigins
    implements MetadataHandler<BuiltInMetadata.ColumnOrigin> {
  protected static final Logger LOG = LoggerFactory.getLogger(ImpalaRelMdColumnOrigins.class.getName());
  public static final RelMetadataProvider SOURCE =
      ReflectiveRelMetadataProvider.reflectiveSource(
          new ImpalaRelMdColumnOrigins(), BuiltInMetadata.ColumnOrigin.Handler.class);

  //~ Constructors -----------------------------------------------------------

  private ImpalaRelMdColumnOrigins() {}
  ...
  public @Nullable Set<RelColumnOrigin> getColumnOrigins(RelNode rel,
    ...
    TableScan tableScan = rel instanceof TableScan ? (TableScan) rel : null;
    set.add(new ImpalaRelColumnOrigin(table, iOutputColumn, false, tableScan));
    return set;
  }
