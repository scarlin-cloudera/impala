...
public class ImpalaRelMdSize extends RelMdSize {
  ...
  // TODO: implementing this for RelSubset doesn't seem like the right option. I think
  // something is off about ImpalaRelMdNonCumulativeCost ignoring computeSelfCost, but
  ...
  public List<Double> averageColumnSizes(TableScan scan, RelMetadataQuery mq) {
    ...
    if (!(scan.getTable() instanceof CalciteTable)) {
      return super.averageColumnSizes(scan, mq);
    }
