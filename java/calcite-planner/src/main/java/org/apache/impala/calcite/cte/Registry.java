...
public final class Registry {
   ...
   * <p>The expressions may contain internal planning concepts such as
   * {@link org.apache.calcite.plan.hep.HepRelVertex}.</p>
   */
  private final Map<String, RelNode> ctes_ = new HashMap<>();
  ...
  public void add(RelNode cte) {
    this.ctes_.put(cte.getDigest(), cte);
  }
  ...
  public Stream<RelNode> entries() {
    return ctes_.values().stream().map(Registry::stripHepVertices);
  }

  private static RelNode stripHepVertices(RelNode rel) {
