...
import org.apache.impala.calcite.rules.CountStarIcebergRule;
import org.apache.impala.calcite.rules.CountStarProjectIcebergRule;
...
public class CalciteOptimizer implements CompilerStep {
  ...
  private RelNode runOptimizeNodesProgram(RelBuilder relBuilder, RexBuilder rexBuilder,
    ...
    List<RelOptRule> interRules = ImmutableList.of(
        ...
        // 1.4.2, so these lines should be uncommented out after this upgrade.
