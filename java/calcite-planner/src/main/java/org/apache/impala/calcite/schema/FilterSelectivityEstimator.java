...
public class FilterSelectivityEstimator {
  ...
  private Double estimateCallSelectivity(RexCall call) {
    switch (call.getOperator().getKind()) {
      ...
      // If this call is part of a conjunction or disjunction, it will be ignored. If it
      // is a standalone condition, the default selectivity will be used.
      default:
        return null;
    }
  }
  ...
  private Double computeIsNotNullSelectivity(RexCall call) {
    ...
    // TODO: IMPALA-XXXXX (file Jira).  This does not seem right. We are returning an
