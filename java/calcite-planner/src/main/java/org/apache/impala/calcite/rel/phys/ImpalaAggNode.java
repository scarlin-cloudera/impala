 ...
 * XXX:
 */
public class ImpalaAggNode extends AggregationNode {
  protected static final Logger LOG = LoggerFactory.getLogger(ImpalaAggNode.class.getName());

  public Double calciteCardinality_ = null;

  public ImpalaAggNode (
      PlanNodeId id, PlanNode input, MultiAggregateInfo multiAggInfo, AggPhase aggPhase) {
    super(id, input, multiAggInfo, aggPhase);
  }
