 ...
 * the RexNodes. The 'simplify' method does the constant folding which
 * can differ from what Impala's constant folding.
 */
...
public class ImpalaCoreRules {
  ...
  public static ImpalaIntersectToDistinctRule IMPALA_INTERSECT_TO_DISTINCT =
      ImpalaIntersectToDistinctRule.Config.DEFAULT
          .withRelBuilderFactory(LOGICAL_BUILDER_NO_SIMPLIFY)
           .as(ImpalaIntersectToDistinctRule.Config.class).toRule();
