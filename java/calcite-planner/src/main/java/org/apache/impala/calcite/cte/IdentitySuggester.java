...
import org.apache.impala.calcite.rules.CommonRelSubExprRegisterRule;

import java.util.List;
import java.util.stream.Collectors;

/**
 * Suggester for common table expressions that appear as is (identical trees) more than
 * once in the query plan.
 */
public class IdentitySuggester implements Suggester {
  @Override
